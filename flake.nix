{
  description = "The Liang hyphenation algorithm";
  ...
  outputs = {
    ...
    flake-utils.lib.eachDefaultSystem (system: let
      ...
      pname = "WoofWare.LiangHyphenation";
    ...
    in {
      ...
      in {
        ...
        default = pkgs.buildDotnetModule {
          ...
          name = "WoofWare.LiangHyphenation";
          src = ./.;
          projectFile = "./WoofWare.LiangHyphenation/WoofWare.LiangHyphenation.fsproj";
